...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/dspic_main_example.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/dspic_main_example.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/dspic_main_example.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   linker.gld
	...
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/dspic_main_example.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
